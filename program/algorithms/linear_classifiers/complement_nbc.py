...
class ComplementNBC:
	...
	def start(self):
		...
		return MeasuringQuality("ComplementNBC","The Complement Naive Bayes classifier described in Rennie et al", train_time_stop-train_time_start,predict_time_stop-predict_time_start,self.data.y_test,y_pred)